...
<div class="row">
    <div class="col-12">
        <form id="myForm" method="post" action="{{ route('sixth-step-update') }}" class="input-style-1">
            @csrf
            <label for="signature">Signature <code>(TYPE YOUR FIRST & LAST NAME. Example- Ali Mbosa) </code></label>
...
<div class="row">
    <div class="col-12">
        ...
        <button id='nextButton' style="color: red;" class="my-btn light-btn py-3 rounded-full px-5 btn-hover">CONTINUE</button>
