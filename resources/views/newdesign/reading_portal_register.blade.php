                            ...
                            <form action="{{ route('reading-portal-register') }}" id="registration_form" method="post">
                                ...
                                <div class="form__body">
                                    ...
                                    <div class="form__row">
                                        ...
                                        <div class="form__controls">
                                            <input type="email" class="form__field" name="email" id="field-regemail" value="{{ old('email', $data1['email']) }}" placeholder="">
                                    ...
                                    <div class="form__row">
                                        ...
                                        <div class="form__controls">
                                            ...
                                            <input type="password" maxlength="16" class="form__field" name="password" id="field-regpassword" value="{{ old('password', $data1['password']) }}" placeholder="">
                                    ...
                                    <div class="form__row">
                                        ...
                                        <div class="form__controls">
                                            ...
                                            <input type="password" maxlength="16" class="form__field" name="cpassword" id="field-cpassword" value="{{ old('password', $data1['password']) }}" placeholder="">
