                            ...
                            <div class="flex flex-col lg:flex-row space-y-12 lg:space-y-0 lg:space-x-14 pt-12">
                                <div class="lg:w-[50%] flex flex-col justify-between1">
                                    <h1 class="text-[#13474d] text-2xl sm:text-base md:text-4xl lg:text-4xl font-extrabold uppercase pb-4">
                                        PRINCETON CLASS OF 1979/APGA AND OKR EXECUTE INSPIRATIONAL SERVICE EVENT AT PRINCETON UNIVERSITY
                                    </h1>
                                    <div class="w-full rounded border-4 border-[#c0414f] border-light-gray">
                                        <img src="myimg/IMG_5511.jpeg" alt="pic-2" class="faatureimg">
                                    </div>
                                    <p class="onlyppp">
                                        For the second consecutive year, Our Kids Read partnered with a major reunion class to bring a day of literacy and mentorship for a group of 45 students from Trenton, NJ. Students from Thomas Jefferson Intermediate School enjoyed activities at Firestone’s Cotsen Children’s Library, a campus tour, lunch and literacy activities alumni Tigers and, of course FREE BOOKS. Special thanks to the Princeton Class of 1979 and the Association of Princeton Graduate alumni for their partnership planning and executing this inspirational event.
</p>
                                </div>
                                <div class="lg:w-[50%] flex flex-col justify-between1">
                                    <h1 class="text-[#13474d] text-2xl sm:text-base md:text-4xl lg:text-4xl font-extrabold uppercase pb-4">
                                       Penguin Random House Books Sponsors OKR x Ford Motor Company Fund Free Book Festival in Detroit, MI
                                    </h1>
                                    <div class="w-full rounded border-4 border-[#c0414f] border-light-gray">
                                        <img src="myimg/IMG_5511.jpeg" alt="pic-3" class="faatureimg">
                                    </div>
                                    <p class="onlyppp">
                                        What an amazing Juneteenth celebration!
Special thanks to Penguin Random House for their donation of 500+ books in support of an Our Kids Read Free Book Festival in Detroit Michigan. Hundreds of members of the Detroit community turned out for the event, there was free food, give aways and, of course, free books and storytelling, courtesy of Our Kids Read </p>
                                </div>
                            </div>
                            <div class="flex flex-col lg:flex-row space-y-12 lg:space-y-0 lg:space-x-14 pt-12">
                                <div class="lg:w-[50%] flex flex-col justify-between1">
                            ...
                            <div class="bg-[#13474d] pl-14 pr-14 w-min">
                                <h1 class="uppercase text-white text-sm sm:text-xl md:text-4xl lg:text-4xl font-extrabold pt-5 pb-5 sm:pt-8 sm:pb-9 whitespace-nowrap rotat">SOCIAL MEDIA HIGHLIGHTS</h1>
                            </div>
                        ...
                        <div class="xl:max-w-5xl max-w-7xl mx-auto px-4 py-10 text-[#13474d]">
                          ...
                          <div class="flex flex-col lg:flex-row space-y-12 lg:space-y-0 lg:space-x-14 pt-12">
                                <div class="lg:w-[50%] flex flex-col justify-between1">
                                    ...
                                    <div class="w-full rounded border-4 border-[#c0414f] border-light-gray" style="background-color: #13474d;">
                                        <img src="myimg/nl_social_media_amber_charter.jpg" alt="pic-2" class="faatureimg">
                                    </div>
                                ...
                                <div class="lg:w-[50%] flex flex-col justify-between1">
                                    ...
                                    <div class="w-full rounded border-4 border-[#c0414f] border-light-gray" style="background-color: #13474d;">
                                        <img src="myimg/nl_social_media_big_vashti.jpg" alt="pic-3" class="faatureimg">
                                    </div>
    ...
    color: white">
                        ...
                        <div class="div-spave" style="margin: 15px 0">
                            ...
                            <img src="myimg/headshot_antonia_brown_REDUCED.jpg" alt="headshot" style="width: 300px; float: left; margin-right: 20px">
                            <span style = "font-size: 1.8rem; font-weight: 700">Antonia Baker</span><br/><br/>
                            
                            <span style="font-size: 1.5rem; font-weight: 600"><i>Multifaceted Global Marketing Leader | Consultant | Advisor</i></span><br/><br/>
...
<br><br>
A first-generation Jamaican-American, Antonia is driven by impacting lives through mentorship and empowering the next generation of leaders to be fearless in changing the world. Antonia holds a B.S. in Marketing from Manhattan College and currently resides in her beloved hometown of New York City   </div>
