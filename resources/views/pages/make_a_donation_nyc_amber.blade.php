                ...
                <div class="shell">
                    <div class="grid grid--full grid--align-center">
                        <div class="grid__col grid__col--9of12">
                            ...
                            <h2 class="heading-2">Make a Donation to Support the OKR x NFL BEN Literacy Event!</h2>
                            ...
                            <div class="ngp-form"
                            data-form-url="https://secure.everyaction.com/v1/Forms/_nw1JuuZRkOGBuGIOI6b5A2"
                            ...
                            style="background-color: #c5e9e1">
                            </div>
                        </div><!-- /.grid__col -->
                        <div class="grid__col grid__col--3of12" style="display: flex; flex-direction: column; align-items: center">
                            <h2>Event Partners:</h2>
                            <img src="{{ asset('new/assets/images/events/NEW_amber_logo.png')}}">
            				<img src="{{ asset('new/assets/images/events/NFL-BEN-Logo-2.jpg')}}" width="200" style="background:#FFF;">
                        </div><!-- /.grid__col -->
                    </div><!-- /.grid -->
                </div><!-- /.shell -->
            </div><!-- /.page-head -->
