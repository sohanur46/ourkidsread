...
<body style="    background: #a7dcd1;">
    ...
    <div class="fixed lg:hidden top-0 bottom-0 left-0 flex flex-col justify-center z-[1] w-0">
            <div id="myContent"
                ...
                <p class="px-4 hover:bg-[#ec3f4f] cursor-pointer pt-[6px] pb-[5px] group flex items-center newsletter-link active" id ="june2024"> <i
                        class="fa-solid fa-caret-right pr-2 text-[#13474d] group-hover:text-white"></i> <span
            ...
            <div class="row">
                <div class="col-lg-3 col-md-12">
                    <div class="  xl:block   fixed sildepop">
                        <div
                            ...
                            <p class="px-4 hover:bg-[#ec3f4f] cursor-pointer pt-[6px] pb-[5px] group flex items-center newsletter-link active" id ="june2024">
                                <i class="fa-solid fa-caret-right pr-2 text-[#13474d] group-hover:text-white"></i> <span
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="w-full  ">
                        ...
                        <div>
                    <img alt="video" height="802" src="{{ asset('new/assets/video/June_2024.gif ')}}" width="100%" height="auto">
                </div>
                                           </div>
                </div>
            </div>
