...
<style>
    ...
    .announcement .icon, .news .icon {
        position: absolute;
        top: -20px;
        left: 47%;
    }
    
    .announcement .icon img, .news .icon img {
        width: 25px;
        height: 25px;
    }
    ...
    @media screen and (max-width: 1024px) {
        .profile-announce, .inbox-news {
            display: block !important;
        }
        
        .announcement, .news, .inbox .header {
            margin-top: 50px;
            margin-bottom: 50px;
        }
...
<body>
    ...
    <div class="page-wrapper">
     <div class="contain">
         ...
         <div class="main">
             <div class="hambuger">READING SESSIONS<span><img onClick="toggleSidebar()" src="https://www.ourkidsread.org/myimg/dashboard/hambuger.svg" alt="menu" /></span></div>
             ...
             <div class="inbox-news" style="display: flex; gap: 30px; margin-top: 30px; flex: 1">
                 <div class="inbox">
                     <div class="schedule">
                         <div class="date"><div style="font-weight: bold">Session Schedule:</div>Tuesday, 5:30 PM EST</div>
